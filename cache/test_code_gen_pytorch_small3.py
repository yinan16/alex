...
def loop(i, trainable_params, data_block_labels, model_block_d_1, data_block_val_labels, val_inputs):
...
loop(i, trainable_params, data_block_labels, model_block_d_1, data_block_val_labels, val_inputs)
